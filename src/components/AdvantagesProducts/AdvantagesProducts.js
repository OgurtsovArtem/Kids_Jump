    ...
    <div className="advantages-products">
      <div className="advantages-products__header">
        <div className="advantages-products__description-block">
          ...
          <p className="advantages-products__text">More than 90 educational games and applications are included with the delivery of the interactive floor.</p>
        </div>
        <ViewButton className="advantages-products__view-button" text="view  all games" />
      </div>
      <div className='advantages-products__cards'>
        <Swiper
          className="_swiper _off-overflow _auto-width"
