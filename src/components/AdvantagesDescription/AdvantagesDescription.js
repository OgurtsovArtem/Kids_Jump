  ...
  return (
    <div className={`${className} advantages-description`}>
      <div className="advantages-description__block">
        <h2 className="advantages-description__title">Our <br /> Advantages</h2>
        <p className="advantages-description__text"><b>KIDSjumpTECH</b> is part of the HighProject group of companies, which has implemented more than 3,000 interactive floor installation projects worldwide.</p>
        <p className="advantages-description__text">Due to the large number of projects our team has identified all the current problems and needs of the market, so we offer our customers the most optimal equipment.</p>
      </div>
      <div className="advantages-description__cards">
        {swiperActive
          ...
          <>
            ...
            >
              <SwiperSlide>
                <AdvantagesCard className="advantages-description__card" iconName="launch-1" />
              </SwiperSlide>
              <SwiperSlide>
                <AdvantagesCard className="advantages-description__card" iconName="launch-1" />
              </SwiperSlide>
