  ...
  return (
    <div className={`${className} advantages-card`} onClick={cardStatus}>
      <div className="advantages-card__content">
        <div
          className={`advantages-card__front ${changeCard ? "_active " : ""}`}
        >
          <button className="advantages-card__button">
            <Icon
              className="advantages-card__change-icon"
              name="more-info-circle"
            />
          </button>
        ...
        <div
          className={`advantages-card__back ${changeCard ? "_active " : ""}`}
        >
          <button className="advantages-card__button">
            <Icon
              className="advantages-card__change-icon"
